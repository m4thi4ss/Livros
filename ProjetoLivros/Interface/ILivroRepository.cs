...
namespace ProjetoLivros.Interface
{
    public interface ILivroRepository
    {
        ...
        void Atualizar(int id, Livro livro); //Aqui ele esta informando que vai atualizar uma informacao ja existente //Na Livro? esta informando que se nao achar a informacao que vai atualizar ele vai lancar o erro, ai nem precisa colocar no repository.
