        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeCategoria = table.Column<int>(type: "int", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TipoUsuarioId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DescricaoTipo = table.Column<int>(type: "int", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usarios", x => x.UsuarioId);
                    table.ForeignKey(
                        name: "FK_Usarios_TiposUsuarios_TipoUsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assinaturas_Usarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usarios",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usarios_Email",
                table: "Usarios",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Usarios_TipoUsuarioId",
                table: "Usarios",
